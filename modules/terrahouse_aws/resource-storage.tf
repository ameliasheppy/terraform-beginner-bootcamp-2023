...
#here we are using a for each loop function to get all of our assets uploaded instead of one at a time
...
#HCL needs for us to change if from JSON : to HCL = below, make note of that!
